...
public:
    ...
    const int64_t& get_cover_image_top_offset() const { return cover_image_top_offset; }
    int64_t& get_mutable_cover_image_top_offset() { return cover_image_top_offset; }
    void set_cover_image_top_offset(const int64_t& value) { this->cover_image_top_offset = value; }
    ...
    void set_canonical_title(const std::string& value) { this->canonical_title = value; }

    const std::vector<std::string>& get_abbreviated_titles() const { return abbreviated_titles; }
    std::vector<std::string>& get_mutable_abbreviated_titles() { return abbreviated_titles; }
    void set_abbreviated_titles(const std::vector<std::string>& value) { this->abbreviated_titles = value; }
    ...
    void set_average_rating(const std::string& value) { this->average_rating = value; }

    const std::map<std::string, std::string>& get_rating_frequencies() const { return rating_frequencies; }
    std::map<std::string, std::string>& get_mutable_rating_frequencies() { return rating_frequencies; }
    void set_rating_frequencies(const std::map<std::string, std::string>& value) { this->rating_frequencies = value; }
    ...
    void set_favorites_count(const int64_t& value) { this->favorites_count = value; }
    ...
    void set_next_release(const std::string& value) { this->next_release = value; }

    const int64_t& get_popularity_rank() const { return popularity_rank; }
    int64_t& get_mutable_popularity_rank() { return popularity_rank; }
    void set_popularity_rank(const int64_t& value) { this->popularity_rank = value; }
    ...
    void set_age_rating_guide(const std::string& value) { this->age_rating_guide = value; }
    ...
    void set_youtube_video_id(const std::string& value) { this->youtube_video_id = value; }
...
void from_json(const nlohmann::json& j, Attributes& attr)
{
    ...
    attr.set_rating_frequencies(get_v<std::map<std::string, std::string>>(j, "ratingFrequencies"));
...
public:
    ...
    const std::map<std::string, Relationship>& get_relationships() const { return relationships; }
    std::map<std::string, Relationship>& get_mutable_relationships() { return relationships; }
    void set_relationships(const std::map<std::string, Relationship>& value) { this->relationships = value; }
};
